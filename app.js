...
app.all("/:number", (req, res) => {
    ...
    if (method === "GET") {
        let { country, city, state, age } = req.query;
        if (country) {
            let filteredUsers = foreigners.filter(
                (u) => !!u.country.match(RegExp(req.query.country, "i"))
            );
            ...
            let filteredUsers = foreigners.filter(
                (u) => !!u.city.match(RegExp(req.query.city, "i"))
            );
            if (filteredUsers.length) {
                if (filteredUsers.length > number)
                    filteredUsers = filteredUsers.slice(0, number);
            ...
            let filteredUsers = foreigners.filter(
                (u) => !!u.state.match(RegExp(req.query.state, "i"))
            );
            if (filteredUsers.length) {
                if (filteredUsers.length > number)
                    filteredUsers = filteredUsers.slice(0, number);
